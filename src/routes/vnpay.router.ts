...
// Lấy con này
routeVnpay.post('/create_payment_url', function (req, res, next) {
...
// Lấy con này
routeVnpay.get('/vnpay_return', function (req, res, next) {
...
// Lấy con này
routeVnpay.get('/vnpay_ipn', function (req, res, next) {
  let vnp_Params = req.query;
  let secureHash = vnp_Params['vnp_SecureHash'];
