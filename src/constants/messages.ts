...
export const messagesSuccess = Object.freeze({
  ...
  // Option value
  GET_OPTIONVALUE_SUCCESS: "Get option value successfully!",
  CREATE_OPTIONVALUE_SUCCESS: "Create option value successfully!",
  UPDATE_OPTIONVALUE_SUCCESS: "Update option value successfully!",
  DELETE_OPTIONVALUE_SUCCESS: "Delete option value successfully!",
